      ...
      <main className="content-wrapper">
        ...
        <section className="pedigree-section">
          ...
          <p className="pedigree-intro">
            Explore the full 10-generation pedigree analysis for Rolex × Piper, including Wright&apos;s cross COI, common ancestor paths, and structural findings.
          </p>
          <a href="/rolex-piper-pedigree.html" className="pedigree-link">
