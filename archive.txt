...
So when did eastern Eurasian dog ancestry arrive in Europe? Previous work attributed this to the Late Neolithic, when Steppe pastoralists brought their dogs west around 5,000 years ago. The Marsh team shows it happened much earlier. Mesolithic dogs from Serbia and Russia (~10,900 years ago) already carried roughly 44% eastern Eurasian dog ancestry, coinciding precisely with the [documented spread of eastern hunter-gatherer human populations into Europe](https://doi.org/10.1038/s41586-023-05726-0). Dogs and people were moving together.
...
*For those interested in exploring modern breed-level genetic data, we’ve built a [Canine Genome Browser](/GreatDaneGenomeBrowser) that provides access to Dog10K project data across over 300 breeds.*

## Dogs Survived the Neolithic Revolution (Even When Humans Didn’t)

The most striking finding is what happened when farming arrived in Europe.
...
> As Hennelly and Sinding note in [their *Nature* commentary](https://doi.org/10.1038/d41586-026-00378-2), this European pattern of dog continuity is actually unusual. **In Asia and the Americas, when people were replaced, their dogs were too. Europe is the exception**: a place where the oldest ancestry of modern dogs reaches all the way back to the Ice Age.
...
Marsh, W. A., Scarsbrook, L., Yüncü, E., et al. (2026). Dogs were widely distributed across western Eurasia during the Palaeolithic. *Nature*, 651, 995–1003. [DOI: 10.1038/s41586-026-10170-x](https://doi.org/10.1038/s41586-026-10170-x)

Bergström, A., Furtwängler, A., Johnston, S., et al. (2026). Genomic history of early dogs in Europe. *Nature*, 651, 986–994. [DOI: 10.1038/s41586-026-10112-7](https://doi.org/10.1038/s41586-026-10112-7)

**Commentary & Coverage:**

Hennelly, L. M. & Sinding, M.-H. S. (2026). Dogs have deep genetic roots in ice-age Europe. *Nature*, 651, 890–891. [DOI: 10.1038/d41586-026-00378-2](https://doi.org/10.1038/d41586-026-00378-2)

Callaway, E. (2026). Who let the wolves in? *Nature News*, 25 March 2026. [DOI: 10.1038/d41586-026-00900-6](https://doi.org/10.1038/d41586-026-00900-6)

**Studies Referenced from Part 1:**

Bergström, A., et al. (2020). Origins and genetic legacy of prehistoric dogs. *Science*, 370, 557–564. [DOI: 10.1126/science.aba9572](https://doi.org/10.1126/science.aba9572)

Frantz, L. A. F., et al. (2016). Genomic and archaeological evidence suggest a dual origin of domestic dogs. *Science*, 352, 1228–1231. [DOI: 10.1126/science.aaf3161](https://doi.org/10.1126/science.aaf3161)

Bergström, A., et al. (2022). Grey wolf genomic history reveals a dual ancestry of dogs. *Nature*, 607, 313–320. [DOI: 10.1038/s41586-022-04824-9](https://doi.org/10.1038/s41586-022-04824-9)

Posth, C., et al. (2023). Palaeogenomics of upper Palaeolithic to neolithic European hunter-gatherers. *Nature*, 615, 117–126. [DOI: 10.1038/s41586-023-05726-0](https://doi.org/10.1038/s41586-023-05726-0)

Charlton, S., et al. (2022). Dual ancestries and ecologies of the Late Glacial Palaeolithic in Britain. *Nature Ecology & Evolution*, 6, 1658–1668. [DOI: 10.1038/s41559-022-01883-z](https://doi.org/10.1038/s41559-022-01883-z)
11:T4907,
[← Back to Blog Archive](/archive)
...
Understanding this deep history provides real insights into genetic diversity, breeding decisions, and what makes dogs special.
...
The question that follows: did this happen once, or multiple times?
...
The debate about dog domestication continues. More ancient genomes are being sequenced, new statistical methods are being developed, and the story will keep evolving with new discoveries.

What we know for certain is that when you look into your dog's eyes, you're looking at the culmination of an epic that spans continents and millennia. A partnership forged in ice age conditions that transformed both species.

The story written in their DNA is far from complete, and each new discovery brings us closer to understanding the full depth of this relationship.
...
</details> 7:["$","div",null,{"className":"content","children":[["$","div",null,{"className":"post-title","children":["$","h1",null,{"children":"Great Dane Articles and Insights"}]}],["$","main",null,{"className":"content-wrapper","children":[["$","section",null,{"className":"hero-section","children":["$","img",null,{"src":"/img/Colorlogo_nobackground.png","alt":"7Sisters Farm Logo","width":300,"height":"auto","className":"hero-logo","loading":"lazy"}]}],["$","$Lf",null,{"posts":[{"title":"The Deep History of Dogs, Part 2: Palaeolithic Partners","description":"Two companion studies in Nature push genetically confirmed dogs to roughly 15,800 years ago, mapping Ice Age dogs across cultures, the Neolithic transition, and the deep ancestry that still flows into modern European breeds.","date":"2026-03-28","categories":["Breeding","Research","Genetics"],"tags":["Domestication","Evolution","Ancient DNA"],"featured":true,"id":"2026-03-28-the-deep-history-of-dogs-palaeolithic-partners","content":"$10"},{"title":"The Deep History of Dogs: A Story Written in Ancient DNA","description":"Explore how ancient DNA research has revolutionized our understanding of dog domestication, revealing a complex story of parallel evolution, population replacements, and a partnership that may have been invented twice.","date":"2025-10-01","categories":["Breeding","Research","Genetics"],"tags":["Domestication","Evolution"],"featured":true,"id":"2025-10-01-the-deep-history-of-dogs-ancient-dna","content":"$11"},{"title":"Breeding for Temperament: What Current Research Tools Tell Us (And What They Don't)","description":"Great Dane history, what temperament tools exist and why they fall short for breeding, what research still teaches us, and practical selection priorities backed by the GDCA health survey.","date":"2025-09-12","updated":"2026-04-07","categories":["Breeding","Temperament","Research"],"tags":["Breeding Science"],"featured":true,"id":"2025-09-12-breeding-for-temperament-research-tools","content":"$12"},{"title":"Feeding Your Growing Great Dane: A Nutritional Deep Dive","date":"2025-07-17","description":"Comprehensive guide to Great Dane nutrition, feeding strategies, and growth management for every life stage, from puppy to adult.","id":"2025-07-17-feeding-your-growing-great-dane","content":"$13","tags":[],"categories":[]},{"title":"The First Year: A Month-by-Month Guide to Early Great Dane Development","date":"2025-07-03","description":"Comprehensive guide to Great Dane puppy development, socialization, feeding, and training tips for new owners from birth to one year.","id":"2025-07-03-the-first-year","content":"$14","tags":[],"categories":[]},{"title":"How to Find Ethical Great Dane Breeders: Complete Guide to Responsible Breeder Selection","date":"2025-06-25","description":"Complete guide to finding ethical Great Dane breeders. Learn what questions to ask, health testing requirements, and how to identify responsible breeders vs puppy mills.","id":"2025-06-25-choosing-a-great-dane-breeder","content":"$15","tags":[],"categories":[]},{"title":"Laying the Foundation: Science, Mentorship, and Our First 7Sisters Litters","date":"2025-06-24","updated":"2026-04-09","description":"Our breeding program is built on exceptional mentors, dogs on both sides of every pedigree, and the research to back it up—how we laid that foundation.","categories":["Breeding","Philosophy"],"tags":["Breeding Philosophy"],"id":"2025-06-24-laying-the-foundation","content":"$16"},{"title":"More Than Show and Go: Our Journey into the Illini Great Dane Club","date":"2025-06-23","description":"Our journey into the Illini Great Dane Club: community, responsible breeding, and show experiences for Great Dane enthusiasts.","id":"2025-06-23-more-than-show-and-go","content":"$17","tags":[],"categories":[]}]}]]}],["$","style",null,{"dangerouslySetInnerHTML":{"__html":"\n            .hero-section {\n              text-align: center;\n              margin-bottom: 2rem;\n            }\n            .hero-logo {\n              max-width: 100%;\n              height: auto;\n              display: block;\n              margin: 0 auto;\n            }\n          "}}]]}]
