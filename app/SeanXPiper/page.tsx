      ...
      <main className="content-wrapper">
        ...
        <section className="pedigree-section">
          ...
          <p className="pedigree-intro">
            Explore the full 10-generation pedigree analysis for Sean × Piper, including Wright&apos;s cross COI, common ancestor paths, and structural findings.
          </p>
          <a href="/sean-piper-pedigree.html" className="pedigree-link">
        ...
        <section className="offspring-section">
          ...
          <div className="puppies-list">
            ...
            <div className="puppy-card">
              ...
              <p className="puppy-name">
                <span className="brand-number">7</span>Sisters N Legado's Cruising
                To The Oldies <span className="call-name">"Cruz"</span>
              </p>
            </div>
            <div className="puppy-card">
